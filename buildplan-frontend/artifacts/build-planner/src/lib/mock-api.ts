...
export const FINISH_LEVELS = ["Standard", "Moderate", "Premium"] as const;
...
export const ACCESS_WAYS = ["East", "West", "Front", "Back"] as const;
...
export const TOPOGRAPHIES = ["Flat", "Sloped", "Moderate"] as const;
...
export const LOCATION_OPTIONS = [
  ...
  { value: "other", label: "Others coming soon" },
] as const;
...
export const REFERENCE_TERMS = [
  { term: "Site", definition: "The land where the project will be developed." },
  { term: "Leasehold", definition: "A land interest held for a fixed number of years." },
  { term: "Regularized documents", definition: "Documents that have been formally processed and recognized." },
  { term: "Feasibility score", definition: "A quick planning indicator for complexity and readiness." },
] as const;
...
export type SpacePreference = (typeof SPACE_TYPES)[number];
